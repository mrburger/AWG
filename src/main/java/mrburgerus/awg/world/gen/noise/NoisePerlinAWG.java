...
public class NoisePerlinAWG extends NoiseGeneratorPerlin
{
    private static int value1 = 16;
    //BEGIN PREWRITTEN CODE


    public NoisePerlinAWG(Random random, int i1)
    {
        super(random, i1);
    ...
    public NoisePerlinAWG(Random random) {
        this(random, value1);
    }
