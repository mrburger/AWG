package mrburgerus.awg.world.gen.noise;
 ...
 */
public class NoiseOctaves2AWG extends NoiseGenerator
{
    public NoiseOctaves2AWG(Random random, int i)
    {
        field_4233_b = i;
        field_4234_a = new GeneratorNoiseAWG[i];
        for(int j = 0; j < i; j++)
        {
            field_4234_a[j] = new GeneratorNoiseAWG(random);
        }
    ...
    private GeneratorNoiseAWG[] field_4234_a;
