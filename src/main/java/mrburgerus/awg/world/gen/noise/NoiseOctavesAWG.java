...
public class NoiseOctavesAWG extends NoiseGeneratorOctaves
{
    //BEGIN PREWRITTEN CODE

    public NoiseOctavesAWG(Random random, int i)
    {
        super(random, i);
        field_1191_b = i;
        field_1192_a = new NoisePerlinAWG[i];
        for(int j = 0; j < i; j++)
        {
            field_1192_a[j] = new NoisePerlinAWG(random);
        }
    ...
    private NoisePerlinAWG[] field_1192_a;
